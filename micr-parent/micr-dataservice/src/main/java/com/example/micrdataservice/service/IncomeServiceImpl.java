...
import com.example.micrdataservice.mapper.IncomeRecordMapper;
...
public class IncomeServiceImpl implements IncomeService {
    ...
    @Override
    public List<IncomeRecord> queryIncomeByUid(Integer uid, Integer pageNo, Integer pageSize) {
        ...
        if (uid != null && uid > 0) {
            ...
            records = incomeMapper.selectIncomeByUid(uid, offset, pageSize);
        }
